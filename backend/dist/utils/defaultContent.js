export const defaultContent = {
    profile: {
        ...
        summary: "Software Engineer with experience building backend APIs in Python and Node.js, AWS cloud services, and distributed monitoring systems. Technical lead for a 7-person test automation team, with production ownership from API design through deployment.",
        about: "I work close to the parts of a product where reliability, data flow, and user impact meet. My recent work includes Python APIs, automation frameworks, REST validation suites, and operational tooling for enterprise monitoring systems. I am especially interested in scalable infrastructure, distributed systems, and clean engineering habits that make teams faster without making systems fragile.",
    ...
    projects: [
        {
            ...
            summary: "MERN + TypeScript portfolio with dynamic blogs, project showcase, JWT-authenticated admin dashboard, MongoDB-backed content APIs, and chatbot-ready architecture.",
            body: "This portfolio is designed as a real product surface, not a static resume page. The backend owns portfolio data in MongoDB, exposes protected APIs for admin updates, and keeps public rendering separate from editing workflows.\n\nThe admin dashboard supports field-based editing for profile content, skills, projects, blogs, and experience. The public side focuses on fast scanning, clear credibility signals, and detailed pages for deeper project reading.",
        ...
        },
        {
            ...
            year: "Personal Project",
            summary: "MERN chat app with Socket.io live messaging, online-status updates, JWT authentication, Zustand state management, and end-to-end deployment.",
            body: "A full-stack chat application built to practice real-time product flows: authentication, protected conversations, live message delivery, and visible online state.\n\nThe application focuses on clean client state management and resilient user feedback for loading, error, and connection states.",
            imageUrl: "/assets/hero-workspace.png",
        ...
        },
        {
            ...
            year: "2024",
            summary: "Leave management platform supporting role-based access control, workflow automation, backup mapping, notifications, and scalable REST APIs.",
            body: "Leave On Time was built around operational clarity: employees can apply for leave, managers can review requests, and teams can understand backup and approval flows without manual follow-up.\n\nThe project includes role-based access control, reusable UI modules, and API design for workflows such as approvals, notifications, and skill mapping.",
            imageUrl: "/assets/hero-workspace.png",
        ...
        },
        {
            ...
            year: "2023",
            summary: "Full-stack legal advisory platform with chatbot-based advisory workflows, CRUD operations, and access controls across multiple resource types.",
            body: "LawSathi explores how a legal advisory product can guide users through structured questions, resource management, and controlled access to legal information.\n\nThe project combines full-stack CRUD workflows with chatbot-style interaction patterns and role-aware resource access.",
            imageUrl: "/assets/hero-workspace.png",
    ...
    blogs: [
        ...
        },
        {
            ...
            excerpt: "Leading automation work sharpened the value of readable test code, repeatable decisions, and feedback loops that help teams ship with less drag.",
            body: "Automation leadership changes how you look at engineering quality. A flaky test or unclear script does not stay small when a team relies on it every day.\n\nThe work pushed me toward readable automation, review habits, and simple conventions that help people move faster. Good automation should reduce doubt, not create another layer of confusion.\n\nThe best feedback loops are the ones engineers actually trust enough to use before production.",
            coverImage: "/assets/hero-workspace.png",
        ...
        },
        {
            ...
            excerpt: "Monitoring tools become useful when they translate technical signals into decisions people can make quickly across staging and production.",
            body: "Distributed monitoring becomes product work when the dashboard starts shaping decisions. It is not enough to show technical signals; the interface has to help people understand what changed, where to look, and how urgent the issue is.\n\nWorking around monitoring systems made me appreciate the connection between backend services, UI clarity, and operational confidence.\n\nThe better the visibility, the easier it is for teams to act before small issues become customer-facing problems.",
            coverImage: "/assets/hero-workspace.png",
